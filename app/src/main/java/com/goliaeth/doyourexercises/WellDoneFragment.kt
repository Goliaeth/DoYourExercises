...
class WellDoneFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        wellDoneButton.setOnClickListener {
            it.findNavController().navigate(R.id.action_wellDoneFragment_to_exerciseFragment)
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment WellDoneFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WellDoneFragment().apply {
